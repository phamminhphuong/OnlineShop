...
<section class="content container-fluid">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Danh sách privacy</h3>
            <h3><a href="admin/privacy/add">Tạo mới</a></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
                            ...
                            <tbody>
                                   ...
                                   <tr role="row" class="odd">
                                       ...
                                       <td>
                                           <a href="admin/privacy/edit/{!!$p->id!!}">Edit</a> |
                                           <a href="/Admin/Products/Details/4">Details</a> |
                                           <a href="admin/privacy/delete/{!!$p->id!!}">Delete</a>
                                       </td>
                               </tr>
